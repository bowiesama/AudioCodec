...
//#define AECM_FLOATPRO
#ifdef AECM_FLOATPRO
#define BAND_RESOLUTION 4
#else
#define BAND_RESOLUTION 1
#endif
enum { kBandFirst = 12*BAND_RESOLUTION };
enum { kBandLast =  kBandFirst+31//43*BAND_RESOLUTION
...
void* WebRtc_CreateDelayEstimatorFarend(int spectrum_size, int history_size) {
  ...
  COMPILE_ASSERT(kBandLast - kBandFirst < 32*BAND_RESOLUTION);
