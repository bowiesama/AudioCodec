...
void Init_Coder_ld8a(CodState *coder);
...
void Init_Decod_ld8a(DecState *decoder);
...
void   update_exc_err(Word16 gain_pit, Word16 t0, Word32 *L_exc_err);
