...
Word16 sature(Word32 L_var1, Flag *Overflow)
  {
   Word16 var_out;
...
Word16 add(Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word16 var_out;
   Word32 L_somme;

   L_somme = (Word32) var1 + var2;
   var_out = sature(L_somme, Overflow);
   return(var_out);
  }
...
Word16 sub(Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word16 var_out;
   Word32 L_diff;

   L_diff = (Word32) var1 - var2;
   var_out = sature(L_diff, Overflow);
   return(var_out);
  }
...
Word16 shl(Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word16 var_out;
   Word32 resultat;
   ...
   if (var2 < 0)
     {
      var_out = shr(var1,-var2, Overflow);
     }
   else
     {
...
Word16 shr(Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word16 var_out;

   if (var2 < 0)
     {
      var_out = shl(var1,-var2, Overflow);
     }
   else
     {
      if (var2 >= 15)
...
Word16 mult(Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word16 var_out;
   Word32 L_produit;
   ...
   var_out = sature(L_produit, Overflow);
   return(var_out);
  }
...
Word32 L_mult(Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word32 L_var_out;
...
Word16 negate(Word16 var1)
  {
   ...
   var_out = ((uint16_t)var1 == MIN_16) ? MAX_16 : -var1;
   return(var_out);
  }
...
Word16 W_round(Word32 L_var1, Flag *Overflow)
  {
   Word16 var_out;
   Word32 L_arrondi;

   L_arrondi = L_add(L_var1, (Word32)0x00008000, Overflow);
...
Word32 L_mac(Word32 L_var3, Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word32 L_var_out;
   Word32 L_produit;

   L_produit = L_mult(var1,var2, Overflow);
   L_var_out = L_add(L_var3,L_produit, Overflow);
   return(L_var_out);
  }
...
Word32 L_msu(Word32 L_var3, Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word32 L_var_out;
   Word32 L_produit;

   L_produit = L_mult(var1,var2, Overflow);
   L_var_out = L_sub(L_var3,L_produit, Overflow);
   return(L_var_out);
  }
...
Word32 L_macNs(Word32 L_var3, Word16 var1, Word16 var2, Flag *Overflow, Flag *Carry)
  {
   Word32 L_var_out;

   L_var_out = L_mult(var1,var2, Overflow);
   L_var_out = L_add_c(L_var3,L_var_out, Overflow, Carry);
   return(L_var_out);
  }
...
Word32 L_msuNs(Word32 L_var3, Word16 var1, Word16 var2, Flag *Overflow, Flag *Carry)
  {
   Word32 L_var_out;

   L_var_out = L_mult(var1,var2, Overflow);
   L_var_out = L_sub_c(L_var3,L_var_out, Overflow, Carry);
   return(L_var_out);
  }
...
Word32 L_add(Word32 L_var1, Word32 L_var2, Flag *Overflow)
  {
   Word32 L_var_out;
...
Word32 L_sub(Word32 L_var1, Word32 L_var2, Flag *Overflow)
  {
   Word32 L_var_out;
...
/*___________________________________________________________________________
 ...
 |___________________________________________________________________________|
*/
Word32 L_add_c(Word32 L_var1, Word32 L_var2, Flag *Overflow, Flag *Carry)
  {
   Word32 L_var_out;
   Word32 L_test;
   Flag carry_int = 0;
...
Word32 L_sub_c(Word32 L_var1, Word32 L_var2, Flag *Overflow, Flag *Carry)
  {
   Word32 L_var_out;
   Word32 L_test;
   Flag carry_int = 0;
   ...
   if (*Carry)
     {
      *Carry = 0;
      if ((uint32_t)L_var2 != MIN_32)
        {
         L_var_out = L_add_c(L_var1,-L_var2, Overflow, Carry);
        }
      else
        {
         L_var_out = L_var1 - L_var2;
...
Word32 L_negate(Word32 L_var1)
  {
   ...
   L_var_out = ((uint32_t)L_var1 == MIN_32) ? (Word32)MAX_32 : -L_var1;
   return(L_var_out);
  }
...
Word16 mult_r(Word16 var1, Word16 var2)
  {
   ...
   var_out = sature(L_produit_arr, &Overflow);
   return(var_out);
  }
...
Word32 L_shl(Word32 L_var1, Word16 var2, Flag *Overflow)
{
   Word32 L_var_out;
   ...
   if (var2 <= 0)
     {
      L_var_out = L_shr(L_var1,-var2, Overflow);
     }
   else
     {
      for(;var2>0;var2--)
...
Word32 L_shr(Word32 L_var1, Word16 var2, Flag *Overflow)
  {
   Word32 L_var_out;

   if (var2 < 0)
     {
      L_var_out = L_shl(L_var1,-var2, Overflow);
     }
   else
     {
      if (var2 >= 31)
...
Word16 shr_r(Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word16 var_out;
...
Word16 mac_r(Word32 L_var3, Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word16 var_out;

   L_var3 = L_mac(L_var3,var1,var2, Overflow);
   L_var3 = L_add(L_var3, (Word32) 0x00008000, Overflow);
...
Word16 msu_r(Word32 L_var3, Word16 var1, Word16 var2, Flag *Overflow)
  {
   Word16 var_out;

   L_var3 = L_msu(L_var3,var1,var2, Overflow);
   L_var3 = L_add(L_var3, (Word32) 0x00008000, Overflow);
   var_out = extract_h(L_var3);
   return(var_out);
  }
...
Word32 L_shr_r(Word32 L_var1,Word16 var2, Flag *Overflow)
  {
   Word32 L_var_out;
...
Word32 L_sat (Word32 L_var1, Flag *Overflow, Flag *Carry)
  {
   Word32 L_var_out;
...
Word16 norm_s(Word16 var1)
  {
   ...
   if (var1 == 0)
     ...
     {
      if ((uint16_t)var1 == (uint16_t) 0xffff)
        {
         var_out = 15;
        }
      else
         ...
         for(iteration=0;iteration<15;iteration++)
           {
            ...
            if (L_num >= L_denom)
              {
               L_num = L_sub(L_num,L_denom, &Overflow);
               var_out = add(var_out,1, &Overflow);
              }
           }
        }
     }
